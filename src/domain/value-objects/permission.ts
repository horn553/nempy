...
const VALID_PERMISSION_LEVELS: readonly PermissionLevel[] = ['viewer', 'editor', 'admin'] as const;
...
export const hasPermission = (permission: Permission, requiredLevel: PermissionLevel): boolean => {
